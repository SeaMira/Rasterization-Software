...
int main(int argc, char* argv[]) 
{
    ...
    CameraController camera_controller(window, camera);
        ...
        ComputeShader spheresShader("assets/shaders/fst_parallel_attempt/fst_parallel.compute");
    #else
        ComputeShader spheresShader("assets/shaders/fst_parallel_attempt/fst_parallel_culling.compute");
    #endif
    ...
    try
    {
        ...
        while ( isRunning )
        {
            ...
            Frustum frustum(camera);
                ...
                spheresShader.setVec4("frustumTopFace", glm::vec4(frustum.topFace.normal, frustum.topFace.distance));
                spheresShader.setVec4("frustumBottomFace", glm::vec4(frustum.bottomFace.normal, frustum.bottomFace.distance));
                spheresShader.setVec4("frustumRightFace", glm::vec4(frustum.rightFace.normal, frustum.rightFace.distance));
                spheresShader.setVec4("frustumLeftFace", glm::vec4(frustum.leftFace.normal, frustum.leftFace.distance));
                spheresShader.setVec4("frustumFarFace", glm::vec4(frustum.farFace.normal, frustum.farFace.distance));
                spheresShader.setVec4("frustumNearFace", glm::vec4(frustum.nearFace.normal, frustum.nearFace.distance));
            #endif
            spheresShader.setVec2I("screenResolution", screenResolution);
            spheresShader.setMat4("proj", camera.getProjection());
            spheresShader.setMat4("view", camera.getView());
            spheresShader.setVec3("up", camera.getUp());
            spheresShader.setVec3("front", camera.getFront());
            spheresShader.setVec3("right", camera.getRight());
            spheresShader.setVec3("cameraPos", camera.getPosition());
            spheresShader.setFloat("fov", camera.getFov()); // visible sphere count given
