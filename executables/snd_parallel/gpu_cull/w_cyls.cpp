...
void mainWithOcclusionCulling(Camera& camera, AppOpenGL& window)
{
    ...
    StorageBuffer cylinderBuffer(GL_SHADER_STORAGE_BUFFER, actualCylinderCount * sizeof(Cylinder), 9,
    ...
    std::string base_path = "media/csv/scnd_parallel_w_cyl/gpu_cull/occ_"; 
    ...
    try
    {
        ...
        while ( isRunning )
        {
            ...
            sphBboxExtractionShader.setInt("sphereCount", actualSphereCount);
            ...
            cylBboxExtractionShader.setInt("cylinderCount", actualCylinderCount); // visible sphere count given
