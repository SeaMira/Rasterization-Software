/**
 * @file screen_clear_ooc.cu
 * @brief Screen clearing for the out-of-core pipeline.
 */

#include <cuda_runtime.h>
#include <device_launch_parameters.h>

__global__ void clearScreenOocKernel(
    ...
    float farPlane)
{
    ...
    uchar4 clearColor = make_uchar4(30, 30, 30, 255);
    ...
    cudaStream_t stream)
{
    ...
    clearScreenOocKernel<<<grid, block, 0, stream>>>(
